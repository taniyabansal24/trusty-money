...
const RefreshSwapIcon = ({
  size = 16,             // default same as original
  color = "#073F9E",     // default same as original
  className = "",
}) => {
  return (
    <svg
...
export default RefreshSwapIcon;