      ...
      <div className="w-full h-full bg-white flex flex-col px-4 py-6">
        ...
        <div className="problem-screen-header flex items-center justify-between mb-4">
          <div>
            ...
            <h3 className="text-[#0A2540] text-base font-semibold">Financial overview</h3>
          </div>

          <div className="w-7 h-7 bg-gradient-to-br from-[#eff6ff] to-[#e0efff] rounded-full flex items-center justify-center overflow-hidden">
        ...
        <div className="space-y-2.5 flex-1">
          ...
          <div
            ...
            className="bg-gradient-to-br from-[#f8fafc] to-white rounded-xl p-4 shadow-lg border-2 border-[#dbeafe] relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-[#eff6ff] to-[#e0efff] rounded-full -mr-6 -mt-6" />
            <div className="relative">
              <div className="flex items-center gap-1.5 mb-1.5">
                <ArrowUpIcon className="w-5 h-5" />
                <span className="text-xs text-[#425466]">Outstanding</span>
              </div>
              <div className="text-lg text-[#0A2540] mb-1">$1.2M</div>
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center gap-1.5 mb-1.5">
                <ClockHistoryIcon size={28} />
                <span className="text-xs text-[#425466]">Avg settlement</span>
              </div>
              <div className="text-lg text-[#0A2540] mb-1">14 days</div>
          ...
          <div
            ...
            className="bg-gradient-to-br from-[#f8fafc] to-white rounded-xl p-3.5 shadow-md border border-[#dbeafe]"
          >
        ...
        {/* CTA */}
        <div className="bg-gradient-to-br from-[#0A2540] to-[#101111] text-white px-5 py-2.5 rounded-full text-sm text-center shadow-lg mt-2">
