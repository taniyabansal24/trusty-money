        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1">
              <span className="text-xs tracking-wide text-blue-600">03 • Payment Infrastructure</span>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <h3 className="text-slate-900">Multi-Currency Accounts</h3>
                </div>
                <p className="text-sm text-slate-600">
                  Hold and manage funds in USD, GBP, EUR, and 15+ currencies with local account details.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <h3 className="text-slate-900">Zero Markup FX</h3>
                </div>
                <p className="text-sm text-slate-600">
                  Convert currencies at true interbank rates with complete transparency and no hidden fees.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <h3 className="text-slate-900">Universal Payment Rails</h3>
                </div>
                <p className="text-sm text-slate-600">
                  Accept wire transfers, SEPA, ACH, cards, and local payment methods through one gateway.
                </p>
              </div>
            </div>
          </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="group relative" style={{ perspective: '1000px' }}>
                    <div 
                      className={`relative overflow-hidden rounded-2xl p-7 shadow-2xl transition-all duration-300 hover:shadow-3xl ${!activeCard.isCustomColor ? `bg-gradient-to-br ${activeCard.color}` : ''}`}
                      style={{ 
                        aspectRatio: '1.586/1',
                      ...
                      <div className="relative z-10 flex h-full flex-col justify-between">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div className={`relative h-11 w-14 overflow-hidden rounded-md bg-gradient-to-br ${activeCard.chipColor} shadow-inner`}>
                              <div className="absolute inset-0 grid grid-cols-4 grid-rows-4 gap-[1px] p-1">
                                {[...Array(16)].map((_, i) => (
                                  <div key={i} className="rounded-[1px] bg-gradient-to-br from-amber-600/40 to-yellow-700/40"></div>
                                ))}
                              </div>
