...
export function WireframeTreasuryDashboard({
  ...
  const dashboardHeight = 700; // Adjust based on your dashboard
  const borderRadius = 12; // rounded-xl = 12px

  // Get chart data from props with fallback
  const chartData = data?.chartData || WireframeTreasuryDashboard.defaultProps.data.chartData;
      ...
      >
        ...
        <div className="border-b border-slate-100 bg-gradient-to-br from-slate-50 to-white px-6 py-3">
          ...
          <motion.div
            ...
            className="rounded-lg border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-4"
          >
        ...
        <div className="p-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            {[
              { label: "DSO", val0: "28 days", val1: "24 days", sub: "↓ 12 days vs baseline", color: "emerald" },
              { label: "Collection Rate", val0: "96.8%", val1: "98.2%", sub: "+4.2% this quarter", color: "emerald" },
              { label: "FX Savings YTD", val0: "$47K", val1: "$51K", sub: "vs market rates", color: "blue" },
              { label: "Expected (48h)", val0: "$324K", val1: "$412K", sub: "12 transactions", color: "blue" }
            ].map((metric, i) => (
              <motion.div
                key={metric.label}
                initial={{ opacity: 0, y: 10 }}
                ...
                <div className="mb-2 flex items-center gap-2 text-xs text-slate-500">
                  <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={
                      i === 0 ? "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" :
                      i === 1 ? "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" :
                      i === 2 ? "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" :
