  ...
  return (
    <div className="bg-gradient-to-br from-white via-slate-50/50 to-indigo-50/30 border border-slate-200/60 rounded-lg overflow-hidden shadow-lg shadow-slate-100/50">
      <div className="border-b border-slate-200/60 px-6 py-4 bg-gradient-to-r from-slate-100/50 to-indigo-100/50">
        <h4 className="text-slate-900 mb-1 text-lg font-semibold">Why Businesses Choose Trusty Money</h4>
        <p className="text-slate-600 text-sm">Feature-by-feature comparison across financial service providers</p>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-200 bg-gradient-to-r from-slate-50 to-indigo-50/30">
              <th className="px-6 py-4 text-left text-slate-700 font-semibold text-xs uppercase tracking-wider">Feature</th>
              <th className="px-6 py-4 text-center text-slate-700 font-semibold text-xs uppercase tracking-wider">Banks</th>
              <th className="px-6 py-4 text-center text-slate-700 font-semibold text-xs uppercase tracking-wider">Gateways</th>
              <th className="px-6 py-4 text-center text-slate-700 font-semibold text-xs uppercase tracking-wider">TrustyMoney</th>
            </tr>
          </thead>
          <tbody>
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-slate-900 font-medium text-sm mb-1">{feature.name}</div>
                        <div className="text-slate-600 text-xs">{feature.description}</div>
                      </div>
                    </div>
                  </td>
