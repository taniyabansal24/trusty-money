      ...
      <div ref={sectionRef} className="relative min-h-[600vh] overflow-hidden">
        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <div className="absolute left-12 sm:left-18 lg:left-[7.5rem] top-[20%] pr-[320px] z-20">
              <div
              ...
              >
                ...
                <p className="text-[#6b7a99] text-sm leading-relaxed">
                  Cross-border payments are slow, expensive, and opaque. Hidden
                  FX margins and unpredictable settlement times drain resources.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="absolute right-12 sm:right-18 lg:right-[7.5rem] top-[20%] pl-[320px] z-20">
              <div
          ...
          >
            ...
            <div className="absolute left-12 sm:left-18 lg:left-[7.5rem] top-[60%] pr-[320px] z-20">
              <div
          ...
          >
            ...
            <div className="absolute right-12 sm:rightt-18 lg:right-32 top-[60%] pl-[320px] z-20">
              <div
          ...
          >
            ...
            {/* <div
              ref={progressBarRef}
              className="absolute left-0 top-0 w-1 bg-gradient-to-b from-blue-500 to-purple-500"
            /> */}
                        ...
                        >
                          <div className="mb-3">
                            <div className="flex justify-between mb-2">
                              ...
                              <span className="text-sm text-[#ff9f43]">
                                68%
                              </span>
                            </div>
