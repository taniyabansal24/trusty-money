...
const SubscriptionCard = () => {
  return (
    <div className="max-w-[450px] mx-auto relative">
      {/* Subscription Title */}
      <div className="text-2xl font-bold text-[#1b1b1b] text-center mb-2">
        Subscription: <span className="text-[#073F9E]">Continuous Access</span>
      </div>

      {/* Description Text */}
      <div className="text-xs text-gray-600 text-center max-w-[450px] mx-auto mb-6">
        A fixed recurring fee for uninterrupted service. Avoid large upfront
        costs and enjoy a predictable plan that ensures your platform and
        features are always active and up to date.
      </div>

      {/* Main Card Container */}
      <div className="bg-white border border-[#E2E8F0] shadow-md rounded-xl p-5 relative overflow-hidden">
        {/* Header with Logo */}
        <div className="flex items-center justify-between gap-2 mb-4">
          <div className="flex flex-row items-center gap-2">
            ...
            <div className="text-sm font-semibold text-[#073F9E]">
              Trusty Money
            </div>
          </div>
          {/* Create Subscription */}
          <div className="text-base font-semibold text-right mb-3 text-[#1b1b1b]">
            Create <span className="text-[#073F9E]">Subscription</span>
          </div>
        </div>
        <hr className="border-[0.5px] border-gray-200 my-3" />
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-2 items-start mr-[60px]">
            {/* Meter Icon */}
            <svg
              width="15"
              height="15"
        ...
        <div className="mb-4 flex item-center justify-between">
          ...
          <div className="space-y-3 w-[15rem]">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-semibold text-[#073F9E]">
                Add Coupon
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="w-[70px] h-3 bg-[rgba(7,63,158,0.1)] rounded-full" />
            </div>

            {/* Trial Row */}
            <div className="flex items-center justify-between">
              <span className="text-xs text-gray-600">Trial</span>
              <div className="w-[50px] h-3 bg-[rgba(7,63,158,0.1)] rounded-full ml-auto" />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3 mt-14">
          <button className="px-4 py-1.5 bg-[#E7ECF6] rounded-lg text-xs text-[#073F9E] shadow-sm">
            Cancel
          </button>
          <button className="px-4 py-1.5 bg-[#073F9E] rounded-lg text-xs text-white shadow-md">
            Start Subscription
          </button>
        </div>
      </div>
