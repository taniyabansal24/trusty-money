...
const CountryTaxCard = () => {
  const countryData = [
    { 
      ...
      currency: "GBP", 
      flag: <GB title="United Kingdom" style={{ width: '20px', height: '14px' }} />, 
      netAmount: "6750.00", 
      tax: "3250.00", 
      totalAmount: "3250.00" 
    },
    { 
      ...
      currency: "USD", 
      flag: <US title="United States" style={{ width: '20px', height: '14px' }} />, 
      netAmount: "6750.00", 
      tax: "3250.00", 
      totalAmount: "3250.00" 
    },
    { 
      country: "UAE", 
      currency: "AED", 
      flag: <AE title="United Arab Emirates" style={{ width: '20px', height: '14px' }} />, 
      netAmount: "6750.00", 
      tax: "3250.00", 
      totalAmount: "3250.00" 
    },
  ...
  return (
    <div className="w-full h-full relative bg-white rounded-[24px] overflow-hidden">
      {/* Main content */}
        ...
        <div className="flex-1 overflow-y-auto pr-1">
          <div className="space-y-4">
            {countryData.map((country, index) => (
              <div key={index} className="bg-white shadow-sm rounded-lg border border-gray-100">
                {/* Card Header */}
                <div className="p-3">
