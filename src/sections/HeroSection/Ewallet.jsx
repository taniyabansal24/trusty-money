...
const Ewallet = () => {
  return (
    <div className="w-full h-full relative">
      ...
      <div className="absolute inset-0 rounded-[28px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] overflow-hidden px-6 py-2">
        ...
        <div className="h-full flex flex-col ">
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-lg text-[#0A0A0A]">E-Wallet</span>
            ...
            <div className="flex items-start justify-between mb-2">
              <div className="flex-1">
                ...
                <div className="relative">
                  <span className="absolute font-medium text-base text-[#073F9E]">
                    $
                  </span>
                  <div className="ml-5">
                    <input
                      type="text"
                      className="text-base text-[#073F9E] bg-transparent outline-none w-full"
                      placeholder="0.00"
              ...
              <div className="relative w-28 h-7">
                ...
                <div className="absolute left-5 top-0 w-20 h-7 bg-white shadow-sm rounded-lg">
                  <div className="flex items-center justify-between px-2 h-full">
                    <span className="text-xs text-black">
                      USD
                    </span>
                    <div className="flex items-center">
                      <div className="w-[0.5px] h-4 bg-gray-300"></div>
          ...
          <div className="mb-6">
            ...
            {/* Amount */}
            <div className="flex justify-between items-center pb-2 border-b border-[#333333] mb-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-xs text-[#073F9E]">
                Completed
              </span>
            </div>
          </div>
