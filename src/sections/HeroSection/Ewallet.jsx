...
const Ewallet = () => {
  return (
    <div className="w-full h-full relative bg-gradient-to-b from-white to-[#EEF4FF] rounded-[28px] p-6 overflow-hidden">
      {/* Title - E-Wallet */}
          ...
          <div className="relative w-32 h-8">
            ...
            <div className="absolute left-6 top-0 w-24 h-8 bg-white shadow-sm rounded-lg">
              <div className="flex items-center justify-between px-2 h-full">
                <span className="font-['DM_Sans'] text-sm text-black">USD</span>
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="relative w-28 h-8">
            ...
            <div className="absolute left-6 top-0 w-20 h-8 bg-white shadow-sm rounded-lg">
              <div className="flex items-center justify-between px-2 h-full">
                <span className="font-['DM_Sans'] text-sm text-black">INR</span>
                <div className="flex items-center">
                  <div className="w-[0.5px] h-5 bg-gray-300"></div>
                  <div className="w-4 h-4 ml-1">
                    <svg
