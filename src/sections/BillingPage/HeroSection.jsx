                ...
                <div className="flex items-start justify-between gap-1.5 self-stretch rounded-md light-bg p-2 text-[13px]">
                  <div className="flex items-start justify-start gap-1.5 md:gap-3">
                    <div
                      ...
                      className={`relative flex h-9 items-center justify-center gap-1 rounded-lg border border-[#d1d9e4] bg-white pl-2 pr-3 transition-transform duration-200 ${
                        buttonClicked && animationStage === 3 ? "scale-95" : ""
                      }`}
                      style={{
                        boxShadow: "rgba(20, 23, 28, 0.08) 0px 2px 2px 0px",
                      }}
                    ...
                    <div
                      id="hero-animation-add-product"
                      className="relative flex h-9 items-center justify-center gap-1 rounded-lg border border-[#d1d9e4] bg-white pl-2 pr-3"
                      style={{
                        boxShadow: "rgba(20, 23, 28, 0.08) 0px 2px 2px 0px",
                      }}
                    >
